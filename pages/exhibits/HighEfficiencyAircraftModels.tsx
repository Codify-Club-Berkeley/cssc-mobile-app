...
export default function HighEfficiencyAircraftModels() {
  ...
  return (
    ...
    <ScrollView 
        ...
        <View >
          ...
          As more people travel by air NASA is working to make greener aircraft. 
          These are two conceptual aircraft designs that use fuel more efficiently.
