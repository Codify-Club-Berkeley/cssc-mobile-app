      ...
      <DemoSection
        ...
        content={
          <>
            ...
            <Text style={globalStyles.bodyText}>
              {"\n"}Dry ice is frozen carbon dioxide (CO₂), the gas we exhale as we
              breathe. It is much denser and colder than traditional ice. {"\n\n"}
              Dry ice is -109.3 F (-79.5 C). Traditional ice is 32 F (0 C).
              If carbon dioxide is stored at 300psi pressure, then it turns
              into a liquid. When fired into a container, the liquid turns in a
              white powder, which is pressed together to form solid dry ice. {"\n\n"}
              ...
              average temperature. {"\n\n"}At normal atmospheric pressure on Earth,
              frozen CO₂ does not melt into a liquid, but rather
              ...
              whole lot of gas! {"\n\n"}Did you know that sound travels more slowly in
              CO₂ than it does in air, just as light travels more slowly in
