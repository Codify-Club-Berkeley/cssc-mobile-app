...
export default function MoonscapeSandbox() {
  ...
  return (
    ...
    <ScrollView 
        ...
        <View
          ...
          <View >
          <Text style={[styles.description, { margin: 30, fontSize: 15, color: "black"}]}>
          Watch the infrared screen: 
          Shadows will get colder, appearing dark blue or black.  
          Bright spots will get warmer, appearing light blue, yellow and orange 
        ...
        <View
          ...
          <View >
          <Text style={[styles.description, { margin: 30, fontSize: 15, color: "black"}]}>
          Infrared is invisible light we feel as heat. This camera makes it visible.  
          Notice: your hands look bright orange on the infrared screen. That’s your body heat! 
          Try warming some Moon sand with your hands and see what happens on screen.
