  ...
  return (
    ...
    <ScrollView 
        ...
        <View
          ...
          <View >
          <Text style={[styles.description, { margin: 30, fontSize: 15, color: "black"}]}>
          Place your battery on a flat base, and the fan on a platform with space to spin.
            </Text>
        ...
        <View
          ...
          <View >
          <Text style={[styles.description, { margin: 30, fontSize: 15, color: "black"}]}>
          Attach the wires to the battery to start your fan.
            </Text>
