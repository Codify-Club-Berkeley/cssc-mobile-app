      ...
      <ScrollView>
        ...
        >
          ...
          >
            ...
            <Text style={globalStyles.bodyText}>Previous Exhibit</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              props.handleNav();
          ...
          >
            ...
            <Text style={globalStyles.bodyText}>Go To Exhibit</Text>
          </TouchableOpacity>
          <TouchableOpacity
            onPress={() => {
              props.handleNav();
          ...
          >
            ...
            <Text style={globalStyles.bodyText}>Next Exhibit</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
