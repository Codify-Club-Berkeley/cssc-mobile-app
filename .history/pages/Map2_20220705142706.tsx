...
export default function MapObject2({ navigation }) {
  ...
  function updateZoom(zoomLevel: number, xPos: number, yPos: number) {
      ...
      <View style={{ borderWidth: 1, flexShrink: 1, height: 500, width: 310 }}>
        ...
        >
          <View style={{ flex: 1, borderWidth: 1, width: 220 }}>
            ...
            >
              <View style={{ flex: 1 }}>
                <View style={{ top: 200, right: 0 }}></View>
        ...
        <View style={{ flex: 0.25, borderWidth: 1 }}>
          ...
          <Text style={globalStyles.headerText}>Level 2</Text>
          ...
          >
            ...
            {/**Map Up */}
            <TouchableOpacity onPress={() => updateZoom()}>
