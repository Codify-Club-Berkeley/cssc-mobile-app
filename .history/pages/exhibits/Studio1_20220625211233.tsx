            ...
            <View style={{ flex: 1, flexDirection: "row", borderWidth: 1 }}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={globalStyles.bodyText}>
                  ...
                  8-foot replica has never been seen by the public! Launching
                  next year, this rover is heading to the Moon to answer big
                  questions about lunar water and how it can be used for future
